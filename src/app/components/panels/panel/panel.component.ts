...
@Component({
    ...
    animations: [
        trigger('panel', [
            ...
            }), {params: {leftCollapsedWidth: DEFAULT_PANEL_CONFIG.leftPanelCollapsedShift}}),
            state('openLeftExpanded', style({
                left: 0,
                transform: 'translateX({{ leftExpandedWidth }}px)'
            }), {params: {leftExpandedWidth: DEFAULT_PANEL_CONFIG.leftPanelExpandedShift}}),
            ...
            }), {params: {rightCollapsedWidth: DEFAULT_PANEL_CONFIG.rightPanelCollapsedShift}}),
            state('openRightExpanded', style({
                right: 0,
                transform: 'translateX(-{{ rightExpandedWidth }}px)'
            }), {params: {rightExpandedWidth: DEFAULT_PANEL_CONFIG.rightPanelExpandedShift}}),
