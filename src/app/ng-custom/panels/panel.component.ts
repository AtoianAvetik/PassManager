...
import { DEFAULT_NGC_PANEL_CONFIG, NGC_PANEL_CONFIG, NgcPanelConfigInterface } from './panel.config';
...
export class NgcPanelComponent implements OnInit, OnDestroy {
    @Input() id: string;
    @Input() dir = 'left';
    ...
    element;
    el: ElementRef;
    config: NgcPanelConfigInterface;
