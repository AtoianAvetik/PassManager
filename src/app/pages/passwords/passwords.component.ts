...
import { NgcNotificationService, NgcModalService, NgcLoaderService } from '../../ng-custom';
...
export class PasswordsComponent implements OnInit, AfterViewInit {
    ...
    smartListSettings = {
        viewType: 'tile',
        exceptionNodes: ['.modal-container', '.cdk-overlay-container']
    };
    ...
    constructor( private dataService: DataService,
                 private modalService: NgcModalService,
                 private loaderService: NgcLoaderService,
                 private notificationService: NgcNotificationService ) {
    }
